...
import { CLOUD_TASK_AUTH, CLOUD_TASK_LOGGER } from "./identifiers";
import type { CloudTaskAuth, CloudTaskLogger } from "./ports";
import {
  CloudTaskEvent,
...
export class CloudTaskService extends TypedEventEmitter<CloudTaskEvents> {
  ...
  constructor(
    ...
    private readonly auth: CloudTaskAuth,
    @inject(CLOUD_TASK_LOGGER)
    private readonly log: CloudTaskLogger,
  ) {
    super();
  }

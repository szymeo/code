...
import {
  CONTEXT_MENU_EXTERNAL_APPS_PORT,
  type ContextMenuExternalApp,
  type ContextMenuExternalAppsPort,
} from "./external-apps-port";
import type {
  ArchivedTaskAction,
...
export class ContextMenuService {
  constructor(
    @inject(CONTEXT_MENU_EXTERNAL_APPS_PORT)
    private readonly externalApps: ContextMenuExternalAppsPort,

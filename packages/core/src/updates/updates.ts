...
import { UPDATES_LOGGER } from "./identifiers";
import {
  UPDATE_LIFECYCLE_PORT,
  type UpdateLifecyclePort,
} from "./lifecycle-port";
import {
...
export class UpdatesService extends TypedEventEmitter<UpdatesEvents> {
  ...
  @inject(UPDATE_LIFECYCLE_PORT)
  private lifecycle!: UpdateLifecyclePort;

  @inject(UPDATES_LOGGER)

...
import { AUTH_PROXY_AUTH, AUTH_PROXY_LOGGER } from "./identifiers";
import type { AuthProxyAuth, AuthProxyLogger } from "./ports";
...
export class AuthProxyService {
  ...
  constructor(
    ...
    @inject(AUTH_PROXY_LOGGER)
    private readonly log: AuthProxyLogger,
  ) {}

...
export class TaskNotificationService {
  constructor(
    ...
    @inject(NOTIFICATION_SETTINGS_PORT)
    private readonly settings: NotificationSettingsPort,
    @inject(ACTIVE_VIEW_PORT)
    private readonly view: ActiveViewPort,
    @inject(COMPLETION_SOUND_PORT)
    private readonly sound: CompletionSoundPort,
  ) {}
  ...
  private dispatch(body: string, taskId?: string): void {
    ...
    this.sound.play(settings.completionSound, settings.completionVolume);

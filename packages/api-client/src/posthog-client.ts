...
import { SEAT_PRODUCT_KEY } from "@posthog/shared";
import type { StoredLogEntry } from "@posthog/shared";
export interface ApiClientLogger {
  warn(...args: unknown[]): void;
}

// PORT NOTE: host-agnostic logger. The desktop host calls
// setPosthogApiClientLogger(logger.scope("posthog-client")) at boot; defaults
// to a no-op so the package never imports the app logger.
